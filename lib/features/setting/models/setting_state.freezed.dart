...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SettingState&&(identical(other.selectedMenu, selectedMenu) || other.selectedMenu == selectedMenu));
}
...
@override
String toString() {
  return 'SettingState(selectedMenu: $selectedMenu)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SettingMenu selectedMenu)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SettingState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SettingMenu selectedMenu)  $default,) {final _that = this;
switch (_that) {
case _SettingState():
return $default(_that.selectedMenu);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SettingMenu selectedMenu)?  $default,) {final _that = this;
switch (_that) {
case _SettingState() when $default != null:
return $default(_that.selectedMenu);case _:
  return null;
...
class _SettingState implements SettingState {
  const _SettingState({this.selectedMenu = SettingMenu.general});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SettingState&&(identical(other.selectedMenu, selectedMenu) || other.selectedMenu == selectedMenu));
}

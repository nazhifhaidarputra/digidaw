...
@override
int get hashCode => Object.hash(runtimeType,currentView,selectedTool,currentToolbarContext,interactionTarget,editingPatternId,horizontalZoomLevel,horizontalClipShiftSizeDenom,gridSize,snapToGrid,showExportPanel,floatingMidiKeyboardState);

@override
String toString() {
  return 'WorkspaceState(currentView: $currentView, selectedTool: $selectedTool, currentToolbarContext: $currentToolbarContext, interactionTarget: $interactionTarget, editingPatternId: $editingPatternId, horizontalZoomLevel: $horizontalZoomLevel, horizontalClipShiftSizeDenom: $horizontalClipShiftSizeDenom, gridSize: $gridSize, snapToGrid: $snapToGrid, showExportPanel: $showExportPanel, floatingMidiKeyboardState: $floatingMidiKeyboardState)';
}
...
@useResult
$Res call({
 WorkspaceView currentView, ToolSelection selectedTool, ToolbarMenuContextGroup currentToolbarContext, InteractionTarget? interactionTarget, int? editingPatternId, double horizontalZoomLevel, MusicalBeatSize horizontalClipShiftSizeDenom, GridSize gridSize, bool snapToGrid, bool showExportPanel, FloatingMidiKeyboardFieldState floatingMidiKeyboardState
});
...
/// Create a copy of WorkspaceState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? currentView = null,Object? selectedTool = null,Object? currentToolbarContext = null,Object? interactionTarget = freezed,Object? editingPatternId = freezed,Object? horizontalZoomLevel = null,Object? horizontalClipShiftSizeDenom = null,Object? gridSize = null,Object? snapToGrid = null,Object? showExportPanel = null,Object? floatingMidiKeyboardState = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( WorkspaceView currentView,  ToolSelection selectedTool,  ToolbarMenuContextGroup currentToolbarContext,  InteractionTarget? interactionTarget,  int? editingPatternId,  double horizontalZoomLevel,  MusicalBeatSize horizontalClipShiftSizeDenom,  GridSize gridSize,  bool snapToGrid,  bool showExportPanel,  FloatingMidiKeyboardFieldState floatingMidiKeyboardState)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WorkspaceState() when $default != null:
return $default(_that.currentView,_that.selectedTool,_that.currentToolbarContext,_that.interactionTarget,_that.editingPatternId,_that.horizontalZoomLevel,_that.horizontalClipShiftSizeDenom,_that.gridSize,_that.snapToGrid,_that.showExportPanel,_that.floatingMidiKeyboardState);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( WorkspaceView currentView,  ToolSelection selectedTool,  ToolbarMenuContextGroup currentToolbarContext,  InteractionTarget? interactionTarget,  int? editingPatternId,  double horizontalZoomLevel,  MusicalBeatSize horizontalClipShiftSizeDenom,  GridSize gridSize,  bool snapToGrid,  bool showExportPanel,  FloatingMidiKeyboardFieldState floatingMidiKeyboardState)  $default,) {final _that = this;
switch (_that) {
case _WorkspaceState():
return $default(_that.currentView,_that.selectedTool,_that.currentToolbarContext,_that.interactionTarget,_that.editingPatternId,_that.horizontalZoomLevel,_that.horizontalClipShiftSizeDenom,_that.gridSize,_that.snapToGrid,_that.showExportPanel,_that.floatingMidiKeyboardState);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( WorkspaceView currentView,  ToolSelection selectedTool,  ToolbarMenuContextGroup currentToolbarContext,  InteractionTarget? interactionTarget,  int? editingPatternId,  double horizontalZoomLevel,  MusicalBeatSize horizontalClipShiftSizeDenom,  GridSize gridSize,  bool snapToGrid,  bool showExportPanel,  FloatingMidiKeyboardFieldState floatingMidiKeyboardState)?  $default,) {final _that = this;
switch (_that) {
case _WorkspaceState() when $default != null:
return $default(_that.currentView,_that.selectedTool,_that.currentToolbarContext,_that.interactionTarget,_that.editingPatternId,_that.horizontalZoomLevel,_that.horizontalClipShiftSizeDenom,_that.gridSize,_that.snapToGrid,_that.showExportPanel,_that.floatingMidiKeyboardState);case _:
  return null;

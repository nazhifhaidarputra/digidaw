...
mixin _$UiMixerChannelSnapshot {
 ...
 int get trackId; int? get busId; bool get isMaster; double get volume; double get pan; bool get mute; bool get solo; bool get invertedPhase;
...
@override
int get hashCode => Object.hash(runtimeType,trackId,busId,isMaster,volume,pan,mute,solo,invertedPhase);

@override
String toString() {
  return 'UiMixerChannelSnapshot(trackId: $trackId, busId: $busId, isMaster: $isMaster, volume: $volume, pan: $pan, mute: $mute, solo: $solo, invertedPhase: $invertedPhase)';
}
...
@useResult
$Res call({
 int trackId, int? busId, bool isMaster, double volume, double pan, bool mute, bool solo, bool invertedPhase
});
...
/// Create a copy of UiMixerChannelSnapshot
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? trackId = null,Object? busId = freezed,Object? isMaster = null,Object? volume = null,Object? pan = null,Object? mute = null,Object? solo = null,Object? invertedPhase = null,}) {
  return _then(_self.copyWith(
trackId: null == trackId ? _self.trackId : trackId // ignore: cast_nullable_to_non_nullable
as int,busId: freezed == busId ? _self.busId : busId // ignore: cast_nullable_to_non_nullable
as int?,isMaster: null == isMaster ? _self.isMaster : isMaster // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int trackId,  int? busId,  bool isMaster,  double volume,  double pan,  bool mute,  bool solo,  bool invertedPhase)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UiMixerChannelSnapshot() when $default != null:
return $default(_that.trackId,_that.busId,_that.isMaster,_that.volume,_that.pan,_that.mute,_that.solo,_that.invertedPhase);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int trackId,  int? busId,  bool isMaster,  double volume,  double pan,  bool mute,  bool solo,  bool invertedPhase)  $default,) {final _that = this;
switch (_that) {
case _UiMixerChannelSnapshot():
return $default(_that.trackId,_that.busId,_that.isMaster,_that.volume,_that.pan,_that.mute,_that.solo,_that.invertedPhase);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int trackId,  int? busId,  bool isMaster,  double volume,  double pan,  bool mute,  bool solo,  bool invertedPhase)?  $default,) {final _that = this;
switch (_that) {
case _UiMixerChannelSnapshot() when $default != null:
return $default(_that.trackId,_that.busId,_that.isMaster,_that.volume,_that.pan,_that.mute,_that.solo,_that.invertedPhase);case _:
  return null;
...
class _UiMixerChannelSnapshot implements UiMixerChannelSnapshot {
  const _UiMixerChannelSnapshot({required this.trackId, this.busId, required this.isMaster, required this.volume, required this.pan, required this.mute, required this.solo, required this.invertedPhase});
  

@override final  int trackId;
@override final  int? busId;
@override final  bool isMaster;
...
/// Create a copy of UiMixerChannelSnapshot
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? trackId = null,Object? busId = freezed,Object? isMaster = null,Object? volume = null,Object? pan = null,Object? mute = null,Object? solo = null,Object? invertedPhase = null,}) {
